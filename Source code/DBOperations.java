...
public class DBOperations {
	...
	public static void starting(Session session, String Monitor_name) {
		...
		String cqlStatementC = "INSERT INTO Monitor(monitor_name,thread_status,monitor_status) VALUES ('"
	...
	{
		String cqlStatementinsert="insert into monitor_transfers(monitor_name,job_name,source_file,transfer_id) "
	...
	{
		String cqlstatementu="update monitor_transfers set target_file='"
	                                       +transferMetaData1.get("destinationFile").replace("\\", "/")+"' "+"where transfer_id= '" +transferMetaData1.get("transferId")+"';";
		session.execute(cqlstatementu);
		String cqlstatementu2="update monitor_transfers set transfer_status ='success' where transfer_id= '" +transferMetaData1.get("transferId")+"';";
